# Starts local dev: PostgreSQL (Docker), the FastAPI backend, and the Vite frontend.
...
Write-Host ""
Write-Host "Backend and frontend are starting in their own windows. Close those windows (or Ctrl+C in each) to stop them."
