...
def main() -> None:
    alice = Employee(
        ...
        product_ids=frozenset({"TJN10001"}),
    ...
    bob = Employee(
        ...
        product_ids=frozenset({"TJN10001", "TJN10018"}),
        region_ids=frozenset({1}),
        latitude=52.10,
        longitude=5.10,
    )
    ...
    visit1 = VisitAssignment(
        ...
        requested_date=date(2026, 9, 1),
        duration_minutes=60,
        required_product_ids=frozenset({"TJN10018"}),
        region_id=1,
        latitude=52.091,
        longitude=5.121,
    )
    ...
    visit2 = VisitAssignment(
        ...
        requested_date=date(2026, 9, 1),
        duration_minutes=60,
        required_product_ids=frozenset({"TJN10001"}),
        region_id=1,
        latitude=52.095,
        longitude=5.125,
    )
    visit3 = VisitAssignment(
        ...
        requested_date=date(2026, 9, 1),
        duration_minutes=45,
        required_product_ids=frozenset({"TJN99999"}),  # nobody has this product
        region_id=1,
        latitude=52.096,
        longitude=5.126,
    )
